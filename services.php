...
<html lang="en">
    ...
    <!-- Section 1: Institute -->
    <div class="row align-items-center" style="margin-bottom: 3rem;">
        ...
        <div class="col-md-6">
            ...
            <p style="line-height: 1.6;">
                ...
                discovering innovations that power sustainable underwater living.
            </p>
        </div>
    </div>

    <!-- Section 2: Office -->
    <div class="row align-items-center flex-row-reverse" style="margin-bottom: 3rem;">
        <div class="col-md-6 text-center">
        ...
        <div class="col-md-6">
            ...
            <p style="line-height: 1.6;">
                ...
                a constant reminder of the symbiosis between humanity and the sea.
            </p>
        </div>
    </div>

    <!-- Section 3: Abyss Room -->
    <div class="row align-items-center" style="margin-bottom: 3rem;">
        ...
        <div class="col-md-12">
            ...
            <p class="text-center" style="line-height: 1.6; max-width: 800px; margin: 1rem auto;">
                ...
                can marvel at the enigmatic Abyss Dwellers and their bioluminescent dance in the dark, uncharted depths.
            </p>
        </div>
    </div>
</div>
